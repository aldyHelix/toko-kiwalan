...
- [x] Fase 2 — Branch (model/repo/Actions · Filament BranchResource CRUD · storefront branch selector + Inertia shared props · RBAC branch-scope: BranchPolicy + BranchScope global scope)
- [ ] Fase 3–8 — lihat [04-task-list.md](./04-task-list.md)
